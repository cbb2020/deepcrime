...
print('poi_0: ', poi[poi['Precincts'] == 0])
...
print('n_prec : ', n_precincts)
uniq_precincts = poi['Precincts'].unique()
print('uniq_prec: ', uniq_precincts)
print(len(uniq_precincts))
inv_prec = {}
for i in range(n_precincts):
  inv_prec[uniq_precincts[i]] = i

poi = poi[poi['Year'] <= 2009]
